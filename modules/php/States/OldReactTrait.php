...
// | | | | |/ _` | | |_) / _ \/ _` |/ __| __|
// | |_| | | (_| | |  _ <  __/ (_| | (__| |_ 
//  \___/|_|\__,_| |_| \_\___|\__,_|\___|\__|
///////////////////////////////////////////////////
/// KEPT ONLY FOR MAKING SURE IT'S NOT BREAKING ONGOING TABLES                                          

trait OldReactTrait
{
  public function argsOldReact()
  {
    ...
    $canPass = $this->canPassOldReact($symbols);
  ...
  public function canPassOldReact($symbols)
  {
    // Mandatory symbols
  ...
  public function actOldReact($symbol, $arg)
  {
    self::checkAction('actOldReact');
    $constructor = Constructors::getActive();
    $symbols = Globals::getSymbols();
    $args = $this->argsOldReact();
  ...
  public function stOldReact()
  {
    $symbols = $this->argsOldReact()['symbols'];
    foreach ($symbols as $symbol => $n) {
      if (in_array($symbol, [REFRESH, DIRECT, ACCELERATE])) {
        if (!empty($n)) {
          return;
  ...
  public function actPassOldReact()
  {
    self::checkAction('actPassOldReact');
  ...
  public function stOldReactDone()
  {
  ...
  /// SALVAGE
  ///////////////////////////////
  public function argsOldSalvage()
  {
    // TODO : remove max
  ...
  /// SUPER COOL
  ///////////////////////////////
  public function argsOldSuperCool()
  {
  ...
  public function actOldCryCauseNotEnoughHeatToPay()
  {
    ...
    $this->gamestate->jumpToState(ST_OLD_PAY_HEATS);
  }

  public function argsOldPayHeats()
  {
    $constructor = Constructors::getActive();
