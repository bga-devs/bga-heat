...
class Cards extends Pieces
{
  ...
  protected static $autoreshuffleCustom = ['sponsors' => 'discard-sponsors', 'upgrades' => 'box'];
  ...
  public static function getDatas()
  {
    ...
    return [
      ...
      // Gas pedal
      24 => $f(ADVANCED_UPGRADE, 1, [DIRECT => 1, SCRAP => 1], clienttranslate('Gas pedal')),
      25 => $f(ADVANCED_UPGRADE, 2, [DIRECT => 1, SCRAP => 2], clienttranslate('Gas pedal')),
      26 => $f(ADVANCED_UPGRADE, 3, [DIRECT => 1, SCRAP => 3], clienttranslate('Gas pedal')),
      27 => $f(ADVANCED_UPGRADE, 4, [DIRECT => 1, HEAT => 1, COOLDOWN => 1], clienttranslate('Gas pedal')),
      ...
      // Suspension
      32 => $f(ADVANCED_UPGRADE, 2, [REFRESH => 1, REDUCE => 1], clienttranslate('Suspension')),
      33 => $f(ADVANCED_UPGRADE, 2, [REFRESH => 1, COOLDOWN => 1], clienttranslate('Suspension')),
      34 => $f(ADVANCED_UPGRADE, 4, [REFRESH => 1], clienttranslate('Suspension')),
      35 => $f(ADVANCED_UPGRADE, 1, [REFRESH => 1, SLIPSTREAM => 1], clienttranslate('Suspension')),
      // Tires
      36 => $f(ADVANCED_UPGRADE, 2, [ADJUST => -1, COOLDOWN => 3], clienttranslate('Tires')),
      37 => $f(ADVANCED_UPGRADE, 1, [SCRAP => 2, ADJUST => 1], clienttranslate('Tires')),
      38 => $f(ADVANCED_UPGRADE, 2, [SCRAP => 2, ADJUST => 1], clienttranslate('Tires')),
      39 => $f(ADVANCED_UPGRADE, 3, [ADJUST => -1, COOLDOWN => 2], clienttranslate('Tires')),
      40 => $f(ADVANCED_UPGRADE, 0, [BOOST => 1, ADJUST => 1, SLIPSTREAM => 1, COOLDOWN => 1], clienttranslate('Tires')),
      41 => $f(ADVANCED_UPGRADE, 0, [BOOST => 2, ADJUST => 2], clienttranslate('Tires')),
      // Turbo charger
      ...
      61 => $f(ADVANCED_UPGRADE, 0, [BOOST => 1, CHAIN_ASPIRATION => 1, ADJUST => 1, REDUCE => 1], clienttranslate('Sliding Skirts'), RR),
