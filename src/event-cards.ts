    ...
    switch (card) {
      ...
      case 9:
        return {
          ...
          rule: _(
            'All drivers start the race with 2 less Heat cards and 1 less Stress card than usual. Hand size is reduced to 6 cards.'
          ),
          year: '1963',
          race: 3,
          country: _('FRANCE'),
      ...
      case 10:
        return {
          ...
          rule: _(
            'All drivers start the race with an extra Stress card from the reserve in their Deck. If you spin out, you are eliminated from the race and score 0 Championship points.'
          ),
          year: '1963',
          race: 4,
          country: _('ITALY'),
      ...
      case 18:
        return {
          ...
          rule: _(
            'This race is one lap longer than usual. Each time you complete a lap, remove a Heat card from the game. (Step 8, remove from: Engine > Hand > Discard > Deck.'
          ),
          year: '1965',
          race: 4,
          country: _('NEDERLAND'),
