...
var CardStock = /** @class */ (function () {
  ...
  CardStock.prototype.removeSelectionClassesFromElement = function (cardElement) {
    ...
    var unselectableCardsClass = this.getUnselectableCardClass();
    var selectedCardsClass = this.getSelectedCardClass();
    cardElement === null || cardElement === void 0
      ? void 0
...
var CardsManager = /** @class */ (function (_super) {
  ...
  function CardsManager(game) {
    var _this =
      _super.call(this, game, {
        getId: function (card) {
          return 'personal-card-'.concat(card.id);
        },
  ...
  CardsManager.prototype.getTooltip = function (card) {
    switch (card.type) {
      ...
      case '104':
        return ''
          .concat(_('Speed card'), '<br>\n                ')
          .concat(_('Speed:'), ' <strong>')
          .concat(Number(card.type) - 100, '</strong>\n                ');
      case '100':
      case '105':
        return ''
          .concat(_('Starting upgrade'), '<br>\n                ')
          .concat(_('Speed:'), ' ')
          .concat(Number(card.type) - 100, '\n                ');
      case '110':
        return _('Stress card');
      case '106':
      case '111':
        return _('Heat card');
    }
  ...
  CardsManager.prototype.getHtml = function (card) {
    ...
    var html =
      '<div class="card personal-card" data-side="front">\n            <div class="card-sides">\n                <div class="card-side front '
        .concat(className, '" ')
        .concat(col !== null ? 'data-col="'.concat(col, '"') : '', ' style="')
        .concat(style, '">')
        .concat(
          type < 100 ? '<div class="text">'.concat(_(card.text), '</div>') : '',
          '\n                </div>\n            </div>\n        </div>'
        );
    return html;
  };
...
var Circuit = /** @class */ (function () {
  function Circuit(game, gamedatas) {
    ...
    Object.values(gamedatas.constructors).forEach(function (constructor) {
      return _this.createCar(constructor);
    });
  }
  /**
  ...
  Circuit.prototype.addMapIndicator = function (cellId, clickCallback) {
    ...
    (mapIndicator.id = 'map-indicator-'.concat(cellId)), mapIndicator.classList.add('map-indicator');
  ...
  Circuit.prototype.removeMapIndicators = function () {
    this.mapDiv.querySelectorAll('.map-indicator').forEach(function (elem) {
      return elem.remove();
    });
  };
  return Circuit;
...
var PERSONAL_CARDS_SORTING = function (a, b) {
...
var InPlayStock = /** @class */ (function (_super) {
  ...
  function InPlayStock(game, constructor) {
    var _this =
      _super.call(this, game.cardsManager, document.getElementById('player-table-'.concat(constructor.pId, '-inplay')), {
  ...
  InPlayStock.prototype.toggleInPlay = function () {
    document.getElementById('player-table-'.concat(this.playerId, '-inplay-wrapper')).dataset.visible =
...
var PlayerTable = /** @class */ (function () {
  function PlayerTable(game, player, constructor) {
    ...
    var html = '\n        <div id="player-table-'
      ...
      .concat(player.color, '; --personal-card-background-y: ')
      .concat((constructor.id * 100) / 6, '%;">\n            <div id="player-table-')
    ...
    html += '\n            <div id="player-table-'
      ...
      .concat(player.color, '">\n                <div id="player-table-')
      .concat(this.playerId, '-deck" class="deck"></div>\n                <div id="player-table-')
      .concat(this.playerId, '-engine" class="engine"></div>\n                <div id="player-table-')
      .concat(this.playerId, '-discard" class="discard"></div>\n                <div id="player-table-')
      .concat(this.playerId, '-gear" class="gear" data-gear="')
      .concat(this.currentGear, '"></div>\n                <div id="player-table-')
      .concat(
        this.playerId,
        '-inplay-wrapper" class="inplay-wrapper">\n                <div class="hand-wrapper">\n                    <div class="block-label">'
      )
      .concat(_('Cards in play'), '</div>\n                        <div id="player-table-')
      .concat(
        this.playerId,
        '-inplay" class="inplay"></div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        '
      );
  ...
  PlayerTable.prototype.setHandSelectable = function (selectionMode, selectableCardsIds, selectedCardsIds) {
    var _this = this;
    if (selectableCardsIds === void 0) {
      selectableCardsIds = null;
    }
    if (selectedCardsIds === void 0) {
      selectedCardsIds = null;
    }
    var cards = this.hand.getCards();
    this.hand.setSelectionMode(
      selectionMode,
      selectableCardsIds
        ? cards.filter(function (card) {
            return selectableCardsIds.includes(Number(card.id));
          })
        : undefined
    );
    selectedCardsIds === null || selectedCardsIds === void 0
      ? void 0
      : selectedCardsIds.forEach(function (id) {
          var _a;
          return (_a = _this.hand.getCardElement(
            cards.find(function (card) {
              return Number(card.id) == Number(id);
            })
          )) === null || _a === void 0
            ? void 0
            : _a.classList.add(_this.hand.getSelectedCardClass());
        }); // TODO make all numbers?
  };
...
function formatTextIcons(str) {
  return str
    .replace(/\[Heat\]/gi, '<div class="heat icon"></div>')
    .replace(/\[Cooldown\]/gi, '<div class="cooldown icon"></div>')
    .replace(/\[Speed\]/gi, '<div class="speed icon"></div>')
    .replace(/\[Boost\]/gi, '<div class="boost icon"></div>');
}
var Heat = /** @class */ (function () {
  ...
  Heat.prototype.setup = function (gamedatas) {
    ...
    g_img_preload.push.apply(
      g_img_preload,
      __spreadArray(
        __spreadArray([], ['Circuits/'.concat(gamedatas.circuit, '.jpg')], false),
        Object.values(gamedatas.players).map(function (player) {
          return 'mats/player-board-'.concat(player.color, '.jpg');
        }),
        false
      )
    );
    ...
    this.onScreenWidthChange = function () {
      return _this.circuit.setAutoZoom();
    };
  ...
  Heat.prototype.onEnteringChooseSpeed = function (args) {
    ...
    Object.entries(args.speeds).forEach(function (entry) {
      return _this.circuit.addMapIndicator(entry[1], function () {
        return _this.actChooseSpeed(Number(entry[0]));
      });
    });
  };
  Heat.prototype.onEnteringSlipstream = function (args) {
    ...
    Object.entries(args.cells).forEach(function (entry) {
      return _this.circuit.addMapIndicator(entry[1][0], function () {
        return _this.actSlipstream(Number(entry[0]));
      });
    });
  };
  ...
  Heat.prototype.onUpdateActionButtons = function (stateName, args) {
    ...
    if (this.isCurrentPlayerActive()) {
      switch (stateName) {
        case 'planification':
          this.addActionButton('actPlanification_button', '', function () {
            return _this.actPlanification();
          });
        ...
        case 'chooseSpeed':
          ...
          Object.entries(chooseSpeedArgs.speeds).forEach(function (entry) {
            _this.addActionButton(
              'chooseSpeed'.concat(entry[0], '_button'),
              _('Move ${cell} cell(s)').replace('${cell}', ''.concat(entry[0])),
              function () {
                return _this.actChooseSpeed(Number(entry[0]));
              }
            );
        ...
        case 'react':
          var reactArgs = args;
          this.addActionButton('actPassReact_button', _('Pass'), function () {
            return _this.actPassReact();
          });
          Object.entries(reactArgs.symbols).forEach(function (entry, index) {
            ...
            _this.addActionButton('actReact'.concat(index, '_button'), formatTextIcons(label), function () {
              return _this.actReact(entry[0]);
            });
          });
          break;
        case 'discard':
  ...
  Heat.prototype.linkButtonHoverToMapIndicator = function (btn, cellId) {
    ...
    btn.addEventListener('mouseenter', function () {
      return mapIndicator === null || mapIndicator === void 0 ? void 0 : mapIndicator.classList.add('hover');
    });
    btn.addEventListener('mouseleave', function () {
      return mapIndicator === null || mapIndicator === void 0 ? void 0 : mapIndicator.classList.remove('hover');
    });
  };
  ///////////////////////////////////////////////////
  //// Utility methods
  ...
  Heat.prototype.createPlayerPanels = function (gamedatas) {
    ...
    Object.values(gamedatas.players).forEach(function (player) {
      ...
      var html = '<div class="counters">\n                <div id="playerhand-counter-wrapper-'
        ...
        .concat(player.id, '"></span>\n                </div>\n                <div id="engine-counter-wrapper-')
        .concat(
          player.id,
          '" class="engine-counter">\n                    <div class="engine icon"></div>\n                    <span id="engine-counter-'
        )
        .concat(
          player.id,
          '"></span>\n                </div>\n            </div>\n            <div class="counters">\n                <div id="speed-counter-wrapper-'
        )
        .concat(
          player.id,
          '" class="speed-counter">\n                    <div class="speed icon"></div>\n                    <span id="speed-counter-'
        )
        .concat(player.id, '">-</span>\n                </div>\n                <div id="turn-counter-wrapper-')
        .concat(
          player.id,
          '" class="turn-counter">\n                    <div class="turn icon"></div>\n                    <span id="turn-counter-'
        )
        .concat(player.id, '">-</span> / ')
        .concat(
          gamedatas.nbrLaps,
        ...
        .concat(player.id, '" class="order-counter">\n                        ')
  ...
  Heat.prototype.getPlayerConstructor = function (playerId) {
    return Object.values(this.gamedatas.constructors).find(function (constructor) {
      return constructor.pId == playerId;
    });
  };
  ...
  Heat.prototype.onHandCardSelectionChange = function (selection) {
    if (this.gamedatas.gamestate.name == 'planification') {
      ...
      var label = allowed
        ? _('Set gear to ${gear} and play selected cards').replace('${gear}', ''.concat(selection.length)) +
          (Math.abs(selection.length - gear) == 2 ? formatTextIcons(' (+1 [Heat])') : '')
        : _('Select between ${min} and ${max} cards')
            .replace('${min}', ''.concat(minAllowed))
            .replace('${max}', ''.concat(maxAllowed));
      document.getElementById('player-table-'.concat(table.playerId, '-gear')).dataset.gear = ''.concat(
        allowed ? selection.length : gear
      );
  ...
  Heat.prototype.notif_reveal = function (args) {
    ...
    this.speedCounters[playerId].setValue(
      cards
        .map(function (card) {
          var _a;
          return (_a = card.speed) !== null && _a !== void 0 ? _a : 0;
        })
        .reduce(function (a, b) {
          return a + b;
        }, 0)
  ...
  Heat.prototype.coloredConstructorName = function (constructorName) {
    return '<span style="font-weight: bold; color: #'
      .concat(
        CONSTRUCTORS_COLORS[
          Object.values(this.gamedatas.constructors).find(function (constructor) {
            return constructor.name == constructorName;
          }).id
        ],
        '">'
      )
      .concat(constructorName, '</span>');
  };
  Heat.prototype.cardImageHtml = function (card, args) {
    var _this = this;
    var _a, _b;
    var constructorId =
      (_a = args.constructor_id) !== null && _a !== void 0
        ? _a
        : (_b = Object.values(this.gamedatas.constructors).find(function (constructor) {
            return constructor.pId == _this.getPlayerId();
          })) === null || _b === void 0
        ? void 0
        : _b.id;
    return '<div class="log-card-image" style="--personal-card-background-y: '
      .concat((constructorId * 100) / 6, '%;">')
      .concat(this.cardsManager.getHtml(card), '</div>');
  };
    ...
    try {
      if (log && args && !args.processed) {
        ...
        if (args.cards_images === '' && args.cards) {
          args.cards_images = Object.values(args.cards)
            .map(function (card) {
              return _this.cardImageHtml(card, args);
            })
            .join('');
        }
        var constructorKeys = Object.keys(args).filter(function (key) {
          return key.substring(0, 16) == 'constructor_name';
        });
        constructorKeys
          .filter(function (key) {
            return args[key][0] != '<';
