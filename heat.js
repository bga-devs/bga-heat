...
var CARDS_DATA = {
  C1_Osirion: {
    number: 1,
    name: 'Osirion',
    text: ['Built for King Seti I of the 19th Dynasty, Abydos is the holy city of the god Osiris.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have 3 <ANCIENT> or 4 <ANCIENT>, gain 4 <VP>.', 'or, if you have 5 <ANCIENT> or more, gain 7 <VP>.'],
    implemented: true,
  },
  C2_AbuGorab: {
    number: 2,
    name: 'Abu Gorab',
    text: ['Located 15 km south of Cairo, it houses the solar temple of King Nyuserre Ini.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have 3 <SECRET> or 4 <SECRET>, gain 4 <VP>.', 'or, if you have 5 <SECRET> or more, gain 7 <VP>.'],
    implemented: true,
  },
  C3_GobekliTepe: {
    number: 3,
    name: 'G\u00f6bekli Tepe',
    text: ['Built around 10,000 BC, this temple challenged our historical chronology.'],
    country: 'T\u00fcrkiye',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 4,
  ...
  C4_Byblos: {
    number: 4,
    name: 'Byblos',
    text: ['The Greeks named it so because papyrus was imported into Greece from Gebal.'],
    country: 'Liban',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 2 <VP> for each set of 3 different types of monuments (<CITY>, <MEGALITH> and <PYRAMID>) in your Past.'],
    implemented: true,
  },
  C5_ElloraCaves: {
    number: 5,
    name: 'Ellora Caves',
    text: ['400 million kg of stone were dug out of the mountain. It is twice the size of the Parthenon in Athens.'],
    country: 'India',
    startingHand: 1,
    startingSpace: 5,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 1 <VP> for each <CITY> in your Past.'],
    implemented: true,
  },
  C6_Ollantaytambo: {
    number: 6,
    ...
    locked: false,
    activation: 'timeline',
    effect: ['Discard 1 <KNOWLEDGE> from each <CITY> adjacent to this card.'],
    implemented: true,
  },
  C7_LuxorTemple: {
    number: 7,
    name: 'Luxor Temple',
    text: ['This Egyptian temple dedicated to the worship of Amun is one of the best preserved buildings from the New Kingdom.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 10,
    ...
    locked: false,
    activation: 'timeline',
    effect: ['If this monument is adjacent to at least 2 <PYRAMID>, discard 3 <KNOWLEDGE> from this monument.'],
    implemented: true,
  },
  C8_Mohenjodaro: {
    number: 8,
    name: 'Mohenjo-daro',
    text: ['The remains of one of the largest cities of the Indian Bronze Age are found here.'],
    country: 'Pakistan',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 9,
  ...
  C9_Petra: {
    number: 9,
    name: 'Petra',
    text: ['Its monumental facades were carved directly into the rock, but its construction date is still debated.'],
    country: 'Jordan',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 1,
    ...
    locked: false,
    activation: 'timeline',
    effect: ['If you have 2 <LOST_KNOWLEDGE> or less on your board and at least 1 monument in your Past, draw 1 card.'],
    implemented: true,
  },
  C10_Parthenon: {
    number: 10,
    name: 'Parthenon',
    text: ['Made entirely of Pentelic marble, the Parthenon is a temple dedicated to the goddess Athena.'],
    country: 'Greece',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 4,
  ...
  C12_Timbuktu: {
    number: 12,
    name: 'Timbuktu',
    text: ['Nicknamed "The City of 333 Saints" or "The Pearl of the Desert."'],
    country: 'Mali',
    startingHand: 0,
    startingSpace: 1,
    initialKnowledge: 2,
    ...
    effect: ['Discard 1 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  C13_LopburiTemple: {
    number: 13,
    name: 'Lopburi Temple',
    text: ['This temple has three towers connected to each other by a corridor, on a north-south axis.'],
    country: 'Thailand',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 1,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Swap this monument with another monument of your Timeline.'],
    implemented: false,
  },
  C14_Bagan: {
    number: 14,
    name: 'Bagan',
    text: ['There are 2834 monuments found on this 50 square km site, many of which are in ruins.'],
    country: 'Myanmar',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 2,
  ...
  C15_AjantaCaves: {
    number: 15,
    name: 'Ajanta Caves',
    text: ['Carved into the steep face of the ravine, the structures range from ten to forty meters in height.'],
    country: 'India',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'decline',
    effect: ['Move another monument to an available space in your Timeline.'],
    implemented: false,
  },
  C16_Heracleion: {
    number: 16,
    name: 'Heracleion',
    text: ['It was discovered in 20001, submerged in the bay of Aboukir, during underwater archaeological excavations.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 2,
  ...
  C17_Jericho: {
    number: 17,
    name: 'Jericho',
    text: ['It is sometimes considered one of the oldest cities in the world.'],
    country: 'Palestine',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
  ...
  C18_AngkorWat: {
    number: 18,
    name: 'Angkor Wat',
    text: ['Angkor is the largest temple and largest religious monument in the world.'],
    country: 'Cambodia',
    startingHand: 0,
    startingSpace: 6,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['If you have at least 1 <CITY> in your Past, your other <CITY> enter play with 1 <KNOWLEDGE> less.'],
    implemented: true,
  },
  C19_Derinkuyu: {
    number: 19,
    name: 'Derinkuyu',
    text: ['This 13-story underground city could accommodate up to 20,000 people.'],
    country: 'T\u00fcrkiye',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'decline',
    effect: ['Discard 4 <KNOWLEDGE> from any of your <CITY> with at least 6 <KNOWLEDGE>.'],
    implemented: true,
  },
  C20_Tiwanaku: {
    number: 20,
    name: 'Tiwanaku',
    text: ['Its two most famous monuments are the seven-step pyramid of Akapana and the famous Gate of the Sun.'],
    country: 'Bolivia',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Discard 1 <KNOWLEDGE> from each of the other <CITY> in your Timeline.'],
    implemented: true,
  },
  C21_Mycenae: {
    number: 21,
    name: 'Mycenae',
    text: ['Mycenae is said to have been founded by Perseus after the accidental homicide of Acrisios, king of Argos.'],
    country: 'Greece',
    startingHand: 0,
    startingSpace: 6,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'decline',
    effect: ['Discard a total of 7 <KNOWLEDGE> or less from one or several of your other monuments.'],
    implemented: true,
  },
  C22_Baalbek: {
    number: 22,
    name: 'Baalbek',
    text: ['The temple of Bacchus, one of the best preserved temples of the Greco-Roman world, is located here.'],
    country: 'Lebanon',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 6,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['If you have at least 3 <CITY> in your Past, this monument enters play with 5 <KNOWLEDGE> less.'],
    implemented: true,
  },
  C23_Sacsayhuaman: {
    number: 23,
    name: 'Sacsayhuam\u00c1n',
    text: ["This fortress is shaped like a puma's head, a sacred animal in Inca tradition."],
    country: 'Peru',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 8,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['If you have at least 3 <CITY> in your Past, this monument enters play with 6 <KNOWLEDGE> less.'],
    implemented: true,
  },
  C24_EasterIsland: {
    number: 24,
    name: 'Easter Island',
    text: ['The first inhabitants called it Rapa Nui, which means "the navel of the world."'],
    country: 'Chile',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['Your other <CITY> enter play with 1 <KNOWLEDGE> less.'],
    implemented: true,
  },
  C25_Llaqtapata: {
    number: 25,
    name: 'Llaqtapata',
    text: ['This was a rest stop on the Inca Trail.'],
    country: 'Peru',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 6,
    ...
    locked: false,
    activation: 'decline',
    effect: ['If this monument has at least 1 <KNOWLEDGE>, discard this card immediately.'],
    implemented: true,
  },
  C26_MachuPicchu: {
    number: 26,
    name: 'Machu Picchu',
    text: ['Its name comes from Quechua (machu: old and pikchu: mountain, summit).'],
    country: 'Peru',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 7,
  ...
  C28_Babylon: {
    number: 28,
    name: 'Babylon',
    text: ['It was undoubtedly the first city to have over 200,000 inhabitants.'],
    country: 'Iraq',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 9,
  ...
  C30_PotalaPalace: {
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Skip your DECLINE PHASE this turn.'],
    implemented: false,
  },
  C31_Philae: {
    number: 31,
    name: 'Philae',
    text: ['This is one of the major shrines of the goddess Isis in Egypt.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['If you have at least 4 <CITY> in your Timeline, choose 2 <CITY> and discard 3 <KNOWLEDGE> from them.'],
    implemented: false,
  },
  C32_Persepolis: {
    number: 32,
    name: 'Persepolis',
    text: ['This former capital of the Persian Achaemenid Empire was built in 521 BC.'],
    country: 'Iran',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['You may take an ARCHIVE action.'],
    implemented: true,
  },
  C33_Inwa: {
    number: 33,
    name: 'Inwa',
    text: ['It was formerly called Ava or Ratanapura: the City of Gems.'],
    country: 'Myanmar',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 6,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['If you have at least 3 <SECRET>,this monument enters play with 5 <KNOWLEDGE> less.'],
    implemented: true,
  },
  C34_TempleOfKomOmbo: {
    number: 34,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['Your <PYRAMID> enter play with 1 <KNOWLEDGE> less.'],
    implemented: true,
  },
  C35_Tulum: {
    number: 35,
    name: 'Tulum',
    text: ['As a trader fort, it seems to have been a major Mayan site dedicated to worshipping the Diving god.'],
    country: 'Mexico',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 1,
  ...
  C36_Cyrene: {
    number: 36,
    name: 'Cyrene',
    text: ['Cyrene was founded by Greeks from Thera following the advice of the Oracle of Delphi.'],
    country: 'Libya',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 8,
    ...
    locked: false,
    activation: 'timeline',
    effect: ['If you have at least 4 <CITY> in your Past, discard 2 <KNOWLEDGE> from this monument.'],
    implemented: true,
  },
  M1_Stonehenge: {
    number: 1,
    name: 'Stonehenge',
    text: ['Astronomical calendar, observatory, or temple dedicated to worshipping the sun? Its function is still debated.'],
    country: 'England',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 2 <VP> for each set of 3 different types of Technology (<ANCIENT>, <WRITING> and <SECRET>) you have.'],
    implemented: true,
  },
  M2_MenhirDiMonteCorruTundu: {
    number: 2,
    name: 'Menhir Di Monte Corru Tundu',
    text: ['Located in Locmariaquer, this menhir was 18.5 m high when erected. Its mass is estimated at 280 tons.'],
    country: 'Italy',
    startingHand: 4,
    startingSpace: 4,
    initialKnowledge: 1,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have at least 15 <LOST_KNOWLEDGE> on your board, gain 9 <VP>.'],
    implemented: true,
  },
  M3_AswanObelisk: {
    number: 3,
    name: 'Aswan Obelisk',
    text: ['Almost 42 meters long, it is cut on three sides. Its weight is estimated at around 1200 tons.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 1 <VP> for each <PYRAMID> in your past.'],
    implemented: true,
  },
  M4_SulawesiMegaliths: {
    number: 4,
    name: 'Sulawesi Megaliths',
    text: ['Discovered in 1908 in the Bada Valley, the dating of these megaliths remains unknown.'],
    country: 'Indonesia',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have at least 7 <MEGALITH> in your Past, gain 6 <VP>.'],
    implemented: true,
  },
  M5_Moron: {
    number: 5,
    name: 'M\u00d6r\u00d6n',
    text: ['The stones of this megalithic site present strange indecipherable engravings.'],
    country: 'Mongolie',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
    ...
    activation: 'endgame',
    effect: [
      '\u2022 If you have 3 <ANCIENT> or 4 <ANCIENT>, gain 4 <VP>.\n\u2022 or, if you have 5 <ANCIENT> or more, gain 7 <VP>.',
    ],
    implemented: true,
  },
  M6_DolmenOfGanghwa: {
    number: 6,
    name: 'Dolmen Of Ganghwa',
    text: ["Korea contains about 40% of the world's dolmens. Most of them are concentrated at the Ganghwa site."],
    country: 'South Korea',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
    ...
    activation: 'endgame',
    effect: [
      '\u2022 If you have 3 <WRITING> or 4 <WRITING>, gain 4 <VP>.\n\u2022 or, if you have 5 <WRITING> or more, gain 7 <VP>.',
    ],
    implemented: true,
  },
  M7_CirclesOfMpumalanga: {
    number: 7,
    name: 'Circles Of Mpumalanga',
    text: [
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 1 <VP> for each <MEGALITH> in your past.'],
    implemented: true,
  },
  M8_DolmenOfGochang: {
    number: 8,
    name: 'Dolmen Of Gochang',
    text: ['In the largest sizes, the cover slabs measure between 1m and 5.8 meters and can weigh from 10 to 30 tons.'],
    ...
    locked: false,
    activation: 'decline',
    effect: ['If you have 5 <MEGALITH> in your Past, discard 7 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  M9_AramuMuru: {
    number: 9,
    name: 'Aramu Muru',
    text: ['This abandoned Inca construction is nicknamed "The Gate of the Gods."'],
    country: 'Peru',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
  ...
  M10_TheFairiesRock: {
    ...
    locked: false,
    activation: 'decline',
    effect: ['Each of your opponents must discard 1 card from their hand.'],
    implemented: false,
  },
  M11_MenhirsOfMonteneuf: {
    number: 11,
    name: 'Menhirs Of Monteneuf',
    text: ['The site consists of more than 400 menhirs made of purple schist.'],
    country: 'France',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'decline',
    effect: ['You may CREATE 1 monument.'],
    implemented: true,
  },
  M12_StatuesOfRamesses: {
    number: 12,
    name: 'Statues Of Ramesses II',
    text: ['This 10 meter tall colossus located in the Luxor Temple has impressive facial symmetry.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 2,
  ...
  M13_CarnacStandingStones: {
    ...
    text: ['This alignment is made up of over 4,000 raised stones over a length of more than one kilometer.'],
    country: 'France',
    startingHand: 0,
    startingSpace: 6,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'decline',
    effect: ['If you have at least 20 <LOST_KNOWLEDGE> on your board, discard 15 <LOST_KNOWLEDGE>.'],
    implemented: true,
  },
  M14_MenhirOfKerloas: {
    number: 14,
    name: 'Menhir Of Kerloas',
    text: ['It is considered the tallest menhir currently standing at 9.50 meters above ground.'],
    country: 'France',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'decline',
    effect: ['Look at one of your opponents\u2019 hands and take 1 card of your choice from them.'],
    implemented: false,
  },
  M15_BarabarCaves: {
    number: 15,
  ...
  M16_DiquisStoneSpheres: {
    number: 16,
    name: 'Diqu\u00cds Stone Spheres',
    text: ['How were these spheres moved across the country and what is their significance? Scientists continue to wonder...'],
    country: 'Costa Rica',
    startingHand: 2,
    startingSpace: 2,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['You may CREATE 1 <ARTEFACT>.'],
    implemented: true,
  },
  M17_FortSamaipata: {
    number: 17,
    name: 'Fort Samaipata',
    text: ['This fort is an immense tabular rock, with basins and canals dug into the rock, accompanied by two feline figures.'],
    country: 'Bolivia',
    startingHand: 4,
    startingSpace: 2,
    initialKnowledge: 6,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['If you have at least 3 <MEGALITH> in your Past, this monument comes into play with 5 <KNOWLEDGE> less.'],
    implemented: true,
  },
  M18_DolmenOfMenga: {
    number: 18,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['You may CREATE an extra monument.'],
    implemented: true,
  },
  M19_DolmenOfFontanaccia: {
    number: 19,
    name: 'Dolmen Of Fontanaccia',
    text: ['Located in Corsica, it is made up of six standing stones, three of which came from the same cracked slab.'],
    country: 'France',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 1,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have at least 10 <LOST_KNOWLEDGE> on your board, gain 4 <VP>.'],
    implemented: true,
  },
  M20_ColossiOfMemnon: {
    number: 20,
    name: 'Colossi Of Memnon',
    text: ['These are the last vestiges of the gigantic temple of Amenhotep III. Each colossus weighs more than 1300 tons.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['Your other <MEGALITH> enter play with 1 <KNOWLEDGE> less.'],
    implemented: true,
  },
  M21_BaalbekTrilithon: {
    number: 21,
    name: 'Baalbek Trilithon',
    text: ['The Stone of the Pregnant Woman is one of the largest monoliths ever cut and transported by man.'],
    country: 'Lebanon',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 7,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['If you have at least 4 <MEGALITH> in your Past, this monument enters play with 6 <KNOWLEDGE> less.'],
    implemented: true,
  },
  M22_HireBenakal: {
    number: 22,
    name: 'Hire Benakal',
    text: ['Made up of more than 400 funerary monuments, the highest dolmen is 3 meters high.'],
    country: 'India',
    startingHand: 3,
    startingSpace: 5,
    initialKnowledge: 2,
    ...
    activation: 'anytime',
    effect: [
      'Each time you LEARN 1 <WRITING> : \n\u2022 discard 1 <KNOWLEDGE> from any of your monuments;\n\u2022 and draw 1 card.',
    ],
    implemented: false,
  },
  M23_StandingStonesOfStenness: {
    number: 23,
    name: 'Standing Stones Of Stenness',
    text: ['Originally made up of a circle of 12 stones, only four remain, the largest with a 6 meter diameter.'],
    country: 'Scotland',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Discard 1 <KNOWLEDGE> from each of your other <MEGALITH>.'],
    implemented: true,
  },
  M24_TlalocsStatue: {
    number: 24,
    name: 'Tlaloc\u2019s Statue',
    text: ['Representing the god of water, this monolith measures about 7 meters and weighs around 165 tons.'],
    country: 'Mexico',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Add 3 <KNOWLEDGE> from the reserve to any monument in each of your opponents\u2019 Timelines.'],
    implemented: false,
  },
  M25_GreatSphinxOfGiza: {
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Add 2 <KNOWLEDGE> from the reserve to any monument in each of your opponents\u2019 Timelines.'],
    implemented: false,
  },
  M26_ChabolaDeLaHechicera: {
    number: 26,
    name: 'Chabola De La Hechicera',
    text: [
    ...
    activation: 'anytime',
    effect: [
      'Each time you CREATE 1 <ARTEFACT> :\n\u2022 discard 1 <KNOWLEDGE> from any of your monuments;\n\u2022 and draw 1 card.',
    ],
    implemented: false,
  },
  M27_MasudaIwafune: {
    number: 27,
    name: 'Masuda Iwafune',
    text: ['The origin and function of this 900 ton monolith are unknown.'],
    country: 'Japan',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['You may CREATE 1 <MEGALITH>.'],
    implemented: true,
  },
  M28_MegalithsOfCauria: {
    number: 28,
    name: 'Megaliths Of Cauria',
    text: ['These Corsican statue-menhirs are considered a particularity within Neolithic anthropomorphic art.'],
    country: 'France',
    startingHand: 0,
    startingSpace: 1,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Add 1 <KNOWLEDGE> from the reserve to any monument in each of your opponents\u2019 Timelines.'],
    implemented: false,
  },
  M29_IshibutaiKofun: {
    number: 29,
    name: 'Ishibutai Kofun',
    text: ['At 54 meters long and composed of 30 stones, this is the largest known megalithic structure in Japan.'],
    country: 'Japan',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'timeline',
    effect: ['If you have at least 5 <LOST_KNOWLEDGE> on your board, discard 1 <LOST_KNOWLEDGE>'],
    implemented: true,
  },
  M30_LeshanGiantBuddha: {
    ...
    locked: false,
    activation: 'timeline',
    effect: ['If you have at least 3 <MEGALITH> in your Past, discard 1 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  M31_HagarQim: {
    number: 31,
    name: '\u0126a\u0120ar Qim',
    text: ['This is a huge complex made up of four temples built over a period of a thousand years.'],
    country: 'Malta',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 3,
  ...
  M32_GiantsTomb: {
    number: 32,
    name: 'Giants\u2019 Tomb',
    text: ['Funeral monument made up of collective burials belonging to the Nuragic culture present in Sardinia.'],
    country: 'Italy',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 1,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have at least 20 <LOST_KNOWLEDGE> on your board, gain 12 <VP>.'],
    implemented: true,
  },
  M33_MerchantsTable: {
    number: 33,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 1 extra <VP> for each monument still in your Timeline.'],
    implemented: true,
  },
  M34_MontguyonDolmen: {
    number: 34,
    name: 'Montguyon Dolmen',
    text: [
    ...
    locked: false,
    activation: 'decline',
    effect: ['You may LEARN 1 Technology without fulfilling the requirements.'],
    implemented: true,
  },
  M35_Ggantija: {
    number: 35,
    name: '\u0120gantija',
    text: ['Made up of 2 megalithic temples, this complex is known for its impressive area (50 \u00d7 35 meters).'],
    country: 'Malta',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 1,
  ...
  M36_PoulnabroneDolmen: {
    ...
    text: ['The rectangular shape of the top table is particularly rare and is said to weigh several tons.'],
    country: 'Ireland',
    startingHand: 0,
    startingSpace: 6,
    initialKnowledge: 0,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['If you have at least 11 cards in your Past when you CREATE a monument, you may CREATE 2 instead.'],
    implemented: false,
  },
  P1_PyramidOfKhafre: {
    number: 1,
    name: 'Pyramid Of Khafre',
    text: ['Second largest pyramid in Egypt, it would have been built for the son of Khufu.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 3,
    ...
    activation: 'endgame',
    effect: [
      '\u2022 If you have between 8 and 11 Technologies, gain 5 <VP>.\n\u2022 or, if you have 12 or more Technologies, gain 12 <VP>.',
    ],
    implemented: true,
  },
  P2_PyramidOfPepi: {
    ...
    text: ['Full of Pyramid Texts, it is the last pyramidal complex of the Old Kingdom.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have at least 7 <CITY> in your Past, gain 6 <VP> '],
    implemented: true,
  },
  P3_MeidumPyramid: {
    number: 3,
    name: 'Meidum Pyramid',
    text: ['Attributed to Sneferu, it was transformed into the first Egyptian smooth-faced pyramid.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
    ...
    activation: 'endgame',
    effect: [
      '\u2022 If you have 3 <SECRET> or 4 <SECRET>, gain 4 <VP>;\n\u2022 or, if you have 5 <SECRET> or more, gain 7 <VP>.',
    ],
    implemented: true,
  },
  P4_Palenque: {
    number: 4,
    name: 'Palenque',
    text: ['Made up of several temples and pyramids, it is one of the most impressive sites of Mayan culture.'],
    country: 'Mexico',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
  ...
  P6_GreatZigguratOfUr: {
    ...
    text: ['One of the four ziggurats that were built in the main religious centers of the land of Sumer.'],
    country: 'Iraq',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 2 <VP> for each set of 3 different types of monuments (<CITY>, <MEGALITH> et <PYRAMID>) in your Past.'],
    implemented: true,
  },
  P7_PyramidOfTheNiches: {
    number: 7,
    name: 'Pyramid Of The Niches',
    text: ['At 18 meters high, this pyramid covers an earlier construction that had similar architecture.'],
    country: 'Mexico',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
  ...
  P8_PyramidOfUserkaf: {
    ...
    text: ['Pyramid from the Fifth Dynasty, it demonstrates a change of ideas in the construction of royal funerary monuments.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'decline',
    effect: ['Each of your opponents must discard 1 <ARTEFACT> from their board.'],
    implemented: false,
  },
  P9_Caral: {
    number: 9,
    ...
    locked: false,
    activation: 'decline',
    effect: ['You may LEARN 1 Technology if you fulfill its requirements.'],
    implemented: true,
  },
  P10_Teotihuacan: {
    number: 10,
    name: 'Teotihuacan',
    text: ['This site includes some of the largest Mesoamerican pyramids ever built. The Pyramid of the Sun is 65 meters high.'],
    country: 'Mexique',
    startingHand: 3,
    startingSpace: 6,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'decline',
    effect: ['You may LEARN up to 2 Technologies if you fulfill their requirements.'],
    implemented: true,
  },
  P11_PyramidOfCoba: {
    number: 11,
    name: 'Pyramid Of Coba',
    text: ['At 42 meters high, the temple of Nohoch Mul is one of the tallest pyramids in the entire Maya region.'],
    country: 'Mexique',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'decline',
    effect: ['If you have at least 3 <MEGALITH> in your Past, discard up to 4 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  P12_GunungPadang: {
    number: 12,
    name: 'Gunung Padang',
    text: ['The geologist Natawidjaja revealed the presence of chambers within it using radar.'],
    country: 'Indonesia',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'decline',
    effect: ['Move 1 another monument in your Timeline to any other available space.'],
    implemented: false,
  },
  P13_Yonaguni: {
    number: 13,
    name: 'Yonaguni',
    text: ['Gigantic underwater pyramid or natural formation?'],
    country: 'Japan',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 14,
  ...
  P14_TikalTempleI: {
    number: 14,
    name: 'Tikal Temple I',
    text: ['One of the largest archaeological sites and urban centers of the pre-Columbian Maya civilization.'],
    country: 'Guatemala',
    startingHand: 3,
    startingSpace: 3,
    initialKnowledge: 4,
  ...
  P15_XixiaWangling: {
    number: 15,
    name: 'Xixia Wangling',
    text: ['The Western Xia Tombs is a mortuary site with an area of 50 square kilometers.'],
    country: 'China',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Discard 3 <KNOWLEDGE> or less from a monument adjacent to this one.'],
    implemented: false,
  },
  P16_NubianPyramids: {
    number: 16,
    name: 'Nubian Pyramids',
    text: ['This is a complex of 220 pyramids in total, which serve as tombs for the kings and queens of Napata and Meroe.'],
    country: 'Sudan',
    startingHand: 4,
    startingSpace: 2,
    initialKnowledge: 3,
  ...
  P17_TheQueensPyramids: {
    number: 17,
    name: 'The Queen\u2019s Pyramids',
    text: ['The pyramid built for Queen Meritites measures 31 meters high.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 5,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['This monument enters play with 1 <KNOWLEDGE> less for each <PYRAMID> in your Past.'],
    implemented: true,
  },
  P18_PyramideDeNice: {
    number: 18,
    name: 'Pyramide De Nice',
    text: ['It was destroyed in the 1970s to build a road interchange. It was over 200 meters long and 50 meters high.'],
    country: 'France',
    startingHand: 1,
    startingSpace: 1,
    initialKnowledge: 2,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Discard 1 <KNOWLEDGE> from any of your monuments.'],
    implemented: true,
  },
  P19_CandiSukuh: {
    number: 19,
    name: 'Candi Sukuh',
    text: ['One of the 5 terraced pyramids of Indonesia. Its base is trapezoidal.'],
    country: 'Indonesia',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['When you LEARN, you may reduce one of the values of the Technology requirements by 1 (to a minimum of 0).'],
    implemented: false,
  },
  P20_BorobudurTemple: {
    number: 20,
    name: 'Borobudur Temple',
    text: ['The temple is lined with 72 stupas which have openwork stone bells housing bodhisattvas.'],
    country: 'Indonesia',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 4,
    ...
    locked: false,
    activation: 'anytime',
    effect: ['Each time you CREATE 1 <ARTEFACT> , you may LEARN 1 Technology if you fulfill its requirements.'],
    implemented: false,
  },
  P21_Phimeanakas: {
    number: 21,
    name: 'Phimeanakas',
    text: ['It is the royal Hindu temple within the grounds of the royal palace of the ancient city Angkor Thom in Angkor.'],
    country: 'Cambodia',
    startingHand: 3,
    startingSpace: 5,
    initialKnowledge: 2,
    ...
    activation: 'anytime',
    effect: [
      'Each time you LEARN 1 <ANCIENT> :\n\u2022 discard 1 <KNOWLEDGE> from any of your monuments;\n\u2022 and draw 1 card.',
    ],
    implemented: false,
  },
  P22_SneferusPyramid: {
    number: 22,
    name: 'Sneferu\u2019s Pyramid',
    text: [
  ...
  P23_PyramidsOfXian: {
    number: 23,
    name: 'Pyramids Of Xi\u2019an',
    text: ['Made of only clay and earth, they measure between 25 and 100 meters high.'],
    country: 'China',
    startingHand: 0,
    startingSpace: 4,
    initialKnowledge: 1,
  ...
  P24_PyramidOfTazumal: {
    number: 24,
    name: 'Pyramid Of Tazumal',
    text: ['The main pyramid of the complex has a base that is 73 by 87 meters wide.'],
    country: 'El Salvador',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 4,
  ...
  P25_ChichenItza: {
    ...
    locked: false,
    activation: 'timeline',
    effect: ['Discard 1 <KNOWLEDGE> from each <MEGALITH> adjacent to this card.'],
    implemented: true,
  },
  P26_Uxmal: {
    number: 26,
    name: 'Uxmal',
    text: ['The levels of the Pyramid of the Magician are unusual: they are oval rather than rectangular or square.'],
    country: 'Mexico',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 1,
  ...
  P27_DahshurPyramid: {
    ...
    text: ['The construction of the Dahshur pyramids was an extremely important learning experience for the Egyptians.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 1,
  ...
  P28_PyramidOfMenkaure: {
    ...
    text: ['It is the smallest of the three great pyramids on the Giza plateau at 63 meters high.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 3,
    initialKnowledge: 2,
  ...
  P29_PyramidOfDjoser: {
    ...
    text: ['In the history of Egyptian architecture, this is the second work built out of cut stone.'],
    country: 'Egypt',
    startingHand: 0,
    startingSpace: 5,
    initialKnowledge: 3,
  ...
  P30_PyramidOfNeferirkare: {
    ...
    locked: false,
    activation: 'timeline',
    effect: ['Discard 1 <KNOWLEDGE> from any other monument.'],
    implemented: true,
  },
  P31_Tonina: {
    number: 31,
    name: 'Tonin\u00c1',
    text: ['This complex consists of 7 terraces for a total height of about 80 meters, flanked by 13 temples and 8 palaces.'],
    country: 'Mexico',
    startingHand: 1,
    startingSpace: 4,
    initialKnowledge: 4,
  ...
  P32_ComalcalcoTemple: {
    ...
    locked: false,
    activation: 'endgame',
    effect: ['Gain 1 <VP> for each monument with a <VP> activation in your Past.'],
    implemented: true,
  },
  P33_Calakmul: {
    number: 33,
  ...
  P34_PyramidsOfPlaineMagnien: {
    ...
    activation: 'decline',
    effect: [
      'Secretly look at the top 8 cards of the Builder deck:\n\u2022 add 1 to your hand;\n\u2022 and discard the other 7 cards.',
    ],
    implemented: false,
  },
  P35_CandiKethek: {
    number: 35,
    name: 'Candi Kethek',
    text: ['The temple has 7 west-facing terraces.'],
    country: 'Indonesia',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'immediate',
    effect: ['Choose 2 available Technologies and put them on the bottom of their respective deck(s).'],
    implemented: false,
  },
  P36_Janggunchong: {
    number: 36,
    name: 'Janggun-chong',
    text: ['Nicknamed the "Tomb of the General," this ancient Korean pyramid is 75 meter high and 11 meters wide.'],
    country: 'China',
    startingHand: 0,
    startingSpace: 2,
    initialKnowledge: 3,
    ...
    locked: false,
    activation: 'endgame',
    effect: ['If you have at least 3 monuments in your Timeline, gain 6 <VP>.'],
    implemented: true,
  },
  A1_DiskOfSabu: {
    number: 1,
    name: 'Disk Of Sabu',
    text: ['Discovered in the tomb of Sabu, its function and meaning remain unknown.'],
    country: 'Egypt',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
    effect: ['If you have at least 4 <MEGALITH> in your Past, discard 1 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  A2_SarcophagusOfSaqqara: {
    number: 2,
    name: 'Sarcophagus Of Saqqara',
    text: ['Built in honor of the god Apis, the serapeum contained more than 20 granite sarcophagi.'],
    country: 'Egypt',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
    effect: [
      'If you have at least 3 <CITY> in your Timeline:\n\u2022 discard 1 <KNOWLEDGE> from any of your monument;\n\u2022 and draw 1 card.',
    ],
    implemented: false,
  },
  A3_PlanetaryStone: {
    number: 3,
    name: 'Planetary Stone',
    text: ['Discovered in 1984, this stone has the contours of a world map.'],
    country: 'Ecuador',
    startingHand: 2,
    discard: 0,
    activation: 'timeline',
  ...
  A4_DisksOfBayanKaraUla: {
    number: 4,
    name: 'Disks Of Bayan Kara Ula',
    text: ['These stone discs have scriptures telling the story of beings crashing on Earth 12,000 years ago.'],
    country: 'China',
    startingHand: 1,
    discard: 0,
    activation: 'timeline',
  ...
  A5_IcaStones: {
    number: 5,
    name: 'Ica Stones',
    text: ['Discovered in 1964, they constitute a collection of over 15,000 engraved andesite pebbles.'],
    country: 'Peru',
    startingHand: 2,
    discard: 0,
    activation: 'timeline',
    effect: ['If you have at least 3 <ARTEFACT> on your board, draw 1 card.'],
    implemented: true,
  },
  A6_AntikytheraMechanism: {
    number: 6,
    name: 'Antikythera Mechanism',
    text: ['This mechanism is considered the first astronomical position calculator.'],
    country: 'Greece',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
  ...
  A7_MoaiStatue: {
    number: 7,
    name: 'Moai Statue',
    text: ['Discovered in Colombia, this statue is strangely reminiscent of the Moai statues of Easter Island.'],
    country: 'Chile',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
    effect: ['You may discard 2 <ARTEFACT> from your hand. If you do, draw 4 cards.'],
    implemented: true,
  },
  A8_LaManAPyramid: {
    number: 8,
    name: 'La Man\u00c1 Pyramid',
    text: ['Strangely resembling the pyramid on the US dollar, its outlines shimmer under black light.'],
    country: 'Ecuador',
    startingHand: 1,
    discard: 0,
    activation: 'timeline',
    effect: ['You may discard 1 card from your hand. If you do, draw 1 card.'],
    implemented: true,
  },
  A9_Tzolkin: {
    number: 9,
    name: 'Tzolk\u2019in',
    text: ['This ritual calendar of 260 days is shared by all the pre-Columbian civilizations of Mesoamerica.'],
    country: 'Mexique',
    startingHand: 2,
    discard: 0,
    activation: 'timeline',
  ...
  A10_IncahuasiQuipus: {
    number: 10,
    name: 'Incahuasi Quipus',
    text: ['Never translated, the quipus served the Incas as a communication and counting system.'],
    country: 'Peru',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
    effect: ['If you have 3 <LOST_KNOWLEDGE> or less on your board and at least 1 monument in your Past, draw 1 card.'],
    implemented: true,
  },
  A11_ParacasCandelabra: {
    number: 11,
    name: 'Paracas Candelabra',
    text: [
  ...
  A12_PachamamaMonolith: {
    ...
    discard: 3,
    activation: 'timeline',
    effect: ['If you have at least 5 <PYRAMID> in your Past, you may LEARN 1 Technology if you fulfill its requirements.'],
    implemented: true,
  },
  A13_PiriReisMap: {
    number: 13,
    name: 'Piri Reis Map',
    text: ['It was drawn by the pirate Piri Reis in 1513. The continent at the bottom of the map could be Antarctica.'],
    country: 'T\u00fcrkiye',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
    effect: ['You may move a monument in your Timeline with 0 <KNOWLEDGE> to any other available space.'],
    implemented: false,
  },
  A14_KlerksdorpSpheres: {
    number: 14,
    name: 'Klerksdorp Spheres',
    text: [
    ...
    discard: 0,
    activation: 'timeline',
    effect: ['If you have at least 5 <LOST_KNOWLEDGE> on your board, draw 1 card.'],
    implemented: true,
  },
  A15_LudditeFlute: {
    number: 15,
    name: 'Luddite Flute',
    text: ['The sound vibration from these stone flutes is exactly the same as our brain waves.'],
    country: 'Bolivia',
    startingHand: 0,
    discard: 0,
    activation: 'timeline',
    effect: ['You may discard this card from your board. If you do, straighten up to 4 monuments from your Past.'],
    implemented: false,
  },
  A16_CrystalSkull: {
    number: 16,
    name: 'Crystal Skull',
    text: ['The pre-Columbian origin of crystal skulls is often questioned.'],
    country: 'Belize',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
  ...
  A17_GlozelArtifacts: {
    ...
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you LEARN 1 <WRITING>, draw 2 cards.'],
    implemented: false,
  },
  A18_DogonMythology: {
    number: 18,
    name: 'Dogon Mythology',
    text: ['Suspected of having discovered the white dwarf Sirius B, the Dogons of Mali have their own astronomical legends.'],
    country: 'Mali',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you LEARN 1 <ANCIENT>, draw 2 cards.'],
    implemented: false,
  },
  A19_VoynichManuscript: {
    ...
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you LEARN 1 <SECRET>, draw 2 cards.'],
    implemented: false,
  },
  A20_SumerianTablets: {
    number: 20,
    name: 'Sumerian Tablets',
    text: [
    ...
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you LEARN 1 Technology (<WRITING>, <ANCIENT> or |secret]), draw 1 card.'],
    implemented: false,
  },
  A21_BaghdadBattery: {
    number: 21,
  ...
  A22_NazcaLines: {
    number: 22,
    name: 'Nazca Lines',
    text: ['These stylized animals or simple lines (that go on for several kilometers) are only visible from the sky.'],
    country: 'Peru',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you CREATE  1 <PYRAMID>, draw 1 card.'],
    implemented: false,
  },
  A23_OlmecHeads: {
    number: 23,
    name: 'Olmec Heads',
    text: ['Carved in basalt, the African features of these statues unleashed passions.'],
    country: 'Mexico',
    startingHand: 4,
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you CREATE 1 <MEGALITH>, draw 1 card.'],
    implemented: false,
  },
  A24_GeneticDisk: {
    number: 24,
    name: 'Genetic Disk',
    text: ['This disc represents genetic elements only visible under a microscope.'],
    country: 'Colombia',
    startingHand: 3,
    discard: 0,
    activation: 'anytime',
  ...
  A25_KensingtonRunestone: {
    ...
    text: ['This stone suggests that Scandinavian explorers reached the center of North America in the 14th century.'],
  ...
  A26_NebraSkyDisc: {
    number: 26,
    name: 'Nebra Sky Disc',
    text: ['This disc is considered the oldest known representation of the celestial vault. Its perimeter is 1 meter around.'],
    country: 'Germany',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
    effect: ['Your <MEGALITH> enter play with 1 <KNOWLEDGE> less.'],
    implemented: true,
  },
  A27_IronPillarOfDelhi: {
    ...
    activation: 'timeline',
    effect: [
      'If you have 2 monuments in space [n\u00b01]:\n\u2022 Discard 1 <KNOWLEDGE> from any of your monument;\n\u2022 and draw 1 card.',
    ],
    implemented: false,
  },
  A28_DogUFigurines: {
    number: 28,
    name: 'Dog\u016a Figurines',
    text: ['The function of these enigmatic statuettes from the J\u014dmon period remains unknown.'],
    country: 'Japan',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
    effect: ['Your <CITY> enter play with 1 <KNOWLEDGE> less.'],
    implemented: true,
  },
  A29_PhaistosDisc: {
    number: 29,
    name: 'Phaistos Disc',
    text: ['Both sides of the disc show 241 signs. Its use, meaning, and even origin are hotly debated.'],
    country: 'Greece',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
    effect: ['Each time you rotate a card during an EXCAVATE action, draw 3 cards instead of 2.'],
    implemented: false,
  },
  A30_NimrudLens: {
    number: 30,
    name: 'Nimrud Lens',
    text: ['It may be the oldest optical lens ever discovered, but its use continues to be debated.'],
    country: 'Iraq',
    startingHand: 0,
    discard: 1,
    activation: 'anytime',
  ...
  A31_SaqqaraVases: {
    ...
    discard: 0,
    activation: 'timeline',
    effect: ['You may discard this card from your board. If you do, move one monument to another available space.'],
    implemented: false,
  },
  A32_ElongatedSkulls: {
    number: 32,
    ...
    discard: 0,
    activation: 'anytime',
    effect: ['For each set of 3 <KNOWLEDGE> becoming <LOST_KNOWLEDGE> during your DECLINE PHASE this turn, draw 2 cards.'],
    implemented: false,
  },
  A33_MichauxStone: {
    number: 33,
  ...
  A35_AssurbanipalsTablet: {
    ...
    discard: 0,
    activation: 'timeline',
    effect: ['If you have 0 or 1 card in your hand, draw 1 card.'],
    implemented: true,
  },
  A36_KhufusSolarBarque: {
    number: 36,
    name: 'Khufu\u2019s Solar Barque',
    text: ['A symbolic object of Egyptian mythology, it is stored disassembled in a pit at the foot of the Pyramid of Khufu.'],
    country: 'Egypt',
    startingHand: 0,
    discard: 0,
    activation: 'anytime',
...
var TECHS_DATA = {
  T1_Anaximenes: {
    ...
    type: 'ancient',
    level: 1,
    requirement: ['3 <ARTEFACT> on your board.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  T2_Aristotle: {
    ...
    type: 'ancient',
    level: 1,
    requirement: ['2 <PYRAMID> in your past.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  ...
  T4_Thales: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Look at the top 8 cards of the deck:\n\u2022 take 1;\n\u2022 and discard the remaining cards.'],
    implemented: false,
  },
  T5_NicolasFlammel: {
    number: 5,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard 1 <LOST_KNOWLEDGE> from your board and draw 1 card.'],
    implemented: true,
  },
  T6_Anaximander: {
    number: 6,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard 1 <KNOWLEDGE> from each <PYRAMID> in your Timeline.'],
    implemented: true,
  },
  T7_Melchizedek: {
    number: 7,
    ...
    type: 'ancient',
    level: 1,
    requirement: ['1 <CITY>, 1 <MEGALITH>, 1 <PYRAMID> in your past.'],
    activation: 'immediate',
    effect: ['Draw 4 cards.'],
    implemented: true,
  },
  T8_Ptolemy: {
    ...
    type: 'ancient',
    level: 1,
    requirement: ['0 or 1 card in your hand.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  T9_Mercury: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard 2 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  T10_PlanetaryGrid: {
    number: 10,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Move 1 monument in your Timeline to any other available space.'],
    implemented: false,
  },
  T11_TheNumberPi: {
    number: 11,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard 1 <KNOWLEDGE> from each <CITY> in your Timeline.'],
    implemented: true,
  },
  T12_Mummification: {
    number: 12,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard as many <KNOWLEDGE> from your Timeline as the number of <ARTEFACT> on your board.'],
    implemented: true,
  },
  T13_MysterySchool: {
    number: 13,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Draw 1 card for each <CITY> in your Timeline.'],
    implemented: true,
  },
  T14_LanguageOfTheBirds: {
    number: 14,
    name: 'Language Of The Birds',
    type: 'secret',
    level: 1,
    requirement: [],
    activation: 'immediate',
    effect: ['Choose 1 monument in your Timeline with at least 5 <KNOWLEDGE>. Discard 3 <KNOWLEDGE> from it.'],
    implemented: false,
  },
  T15_FlowerOfLife: {
    number: 15,
    ...
    type: 'secret',
    level: 1,
    requirement: ['2 <CITY> in your past.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  T16_SatorSquare: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Swap 2 monuments in your Timeline.'],
    implemented: false,
  },
  T17_EarthquakeEngineering: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Discard up to 3 cards, then draw 1 card for each discarded card.'],
    implemented: false,
  },
  T18_Astronomy: {
    number: 18,
    ...
    type: 'secret',
    level: 1,
    requirement: ['1 <CITY>, 1 <PYRAMID> in your past.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  T19_RunicAlphabet: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Straighten 2 rotated monuments in your Past.'],
    implemented: false,
  },
  T20_RongorongoGlyphs: {
    number: 20,
    name: 'Rongorongo Glyphs',
    type: 'writing',
    level: 1,
    requirement: [],
    activation: 'immediate',
    effect: ['Discard 1 <KNOWLEDGE> from each <MEGALITH> in your Timeline.'],
    implemented: true,
  },
  T21_AncientHebrew: {
    number: 21,
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Choose 1 monument in each of your opponents\u2019 Timelines and add 1 <KNOWLEDGE> to each. Draw 1 card.'],
    implemented: false,
  },
  T22_AncientGreek: {
    number: 22,
    ...
    activation: 'immediate',
    effect: [
      'Draw the top 10 cards of the deck:\n\u2022 choose and CREATE 1 <ARTEFACT>;\n\u2022 and discard the remaining cards.',
    ],
    implemented: false,
  },
  T23_ArabicNumerals: {
    ...
    type: 'writing',
    level: 1,
    requirement: ['5 <LOST_KNOWLEDGE> on your board.'],
    activation: 'immediate',
    effect: ['Discard 3 <LOST_KNOWLEDGE> from your board.'],
    implemented: true,
  },
  T24_Protowriting: {
    number: 24,
    ...
    type: 'writing',
    level: 1,
    requirement: ['4 monuments in your Past.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  T25_CopticAlphabet: {
    ...
    type: 'writing',
    level: 1,
    requirement: ['2 <MEGALITH> in your Past.'],
    activation: 'immediate',
    effect: ['Draw 3 cards.'],
    implemented: true,
  },
  T26_CretanHieroglyphs: {
    ...
    requirement: [],
    activation: 'immediate',
    effect: ['Each of your opponents discards 1 card from their hand.'],
    implemented: false,
  },
  T27_LatinAlphabet: {
    number: 27,
    ...
    type: 'writing',
    level: 1,
    requirement: ['5 monuments in your Past.'],
    activation: 'immediate',
    effect: ['Choose 1 Technology [II], and put it on the bottom of the corresponding deck.'],
    implemented: false,
  },
  T28_Imhotep: {
    number: 28,
    ...
    type: 'ancient',
    level: 2,
    requirement: ['4 <ARTEFACT> on your board.'],
    activation: 'endgame',
    effect: ['3 <VP>'],
    implemented: true,
  },
  T29_Plato: {
    ...
    type: 'ancient',
    level: 2,
    requirement: ['7 monuments of the same type in your Past.'],
    activation: 'endgame',
    effect: ['4 <VP>'],
    implemented: true,
  },
  T30_Thoth: {
    ...
    type: 'ancient',
    level: 2,
    requirement: ['9 <LOST_KNOWLEDGE> on your board.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T31_Pythagoras: {
    ...
    type: 'ancient',
    level: 2,
    requirement: ['3 monuments with <VP> activation in your Past.'],
    activation: 'endgame',
    effect: ['3 <VP>'],
    implemented: true,
  },
  T32_Akhenaten: {
    ...
    type: 'ancient',
    level: 2,
    requirement: ['4 <PYRAMID> in your past.'],
    activation: 'endgame',
    effect: ['3 <VP>'],
    implemented: true,
  },
  T33_PlinyTheElder: {
    ...
    type: 'ancient',
    level: 2,
    requirement: ['3 <ANCIENT> in your collection.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T34_GoldenMean: {
    ...
    type: 'secret',
    level: 2,
    requirement: ['3 <CITY> in your past.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T35_RoyalCubit: {
    ...
    type: 'secret',
    level: 2,
    requirement: ['3 <SECRET> in your collection.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T36_Astrology: {
    ...
    type: 'secret',
    level: 2,
    requirement: ['10 cards in your hand.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  ...
  T38_Hermeticism: {
    ...
    type: 'secret',
    level: 2,
    requirement: ['5 <CITY> in your past.'],
    activation: 'endgame',
    effect: ['3 <VP>'],
    implemented: true,
  },
  T39_Arikat: {
    ...
    type: 'secret',
    level: 2,
    requirement: ['3 <CITY>, 3 <MEGALITH>, 3 <PYRAMID> in your past.'],
    activation: 'endgame',
    effect: ['5 <VP>'],
    implemented: true,
  },
  T40_ChineseAlphabet: {
    number: 40,
    name: 'Chinese Alphabet',
    type: 'writing',
    level: 2,
    requirement: ['3 <MEGALITH> in your past.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T41_EmeraldTablet: {
    ...
    type: 'writing',
    level: 2,
    requirement: ['3 <WRITING> in your collection.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T42_SumerianCuneiforms: {
    number: 42,
    name: 'Sumerian Cuneiforms',
    type: 'writing',
    level: 2,
    requirement: ['6 Technology cards (<ANCIENT>,<WRITING> ou <SECRET>).'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T43_MayaScript: {
    ...
    type: 'writing',
    level: 2,
    requirement: ['10 monuments in your past.'],
    activation: 'endgame',
    effect: ['2 <VP>'],
    implemented: true,
  },
  T44_PhoenicianAlphabet: {
    ...
    type: 'writing',
    level: 2,
    requirement: ['15 <LOST_KNOWLEDGE> on your board.'],
    activation: 'endgame',
    effect: ['4 <VP>'],
    implemented: true,
  },
  T45_Hieroglyphs: {
    ...
    type: 'writing',
    level: 2,
    requirement: ['5 <MEGALITH> in your past.'],
    activation: 'endgame',
    effect: ['4 <VP>'],
    implemented: true,
  },
...
var BuilderCardsManager = /** @class */ (function (_super) {
  ...
  BuilderCardsManager.prototype.setupFrontDiv = function (card, div, ignoreTooltip) {
    ...
    var html = '\n        <div id="'
      .concat(card.id, '-tokens" class="background" data-type="')
  ...
  BuilderCardsManager.prototype.getTooltip = function (card) {
    ...
    var typeLetter = card.id.substring(0, 1);
    var message = '\n        <strong>'
      .concat(card.name, '</strong>\n        <br>\n        <i>')
      .concat(card.country, '</i>\n        <br>\n        <br>\n        <strong>')
      .concat(_('Type:'), '</strong> ')
      .concat(this.getType(card.id), '\n        ');
    if (card.startingSpace) {
      message += '\n            <br>\n            <strong>'
        .concat(_('Starting space:'), '</strong> ')
        .concat(card.startingSpace, '\n            ');
    }
    if (card.discard) {
      message += '\n            <br>\n            <strong>'
        .concat(_('Discard cards:'), '</strong> ')
        .concat(card.discard, '\n            ');
    }
    if (card.locked) {
    ...
    if (typeLetter != 'A') {
      message += '\n            <br>\n            <strong>'
        .concat(_('Initial knowledge:'), '</strong> ')
        .concat(card.initialKnowledge, '\n            <br>\n            <strong>')
        .concat(_('Victory point:'), '</strong> ')
        .concat(card.victoryPoint, '\n            ');
    }
    message += '\n        <br>\n        <strong>'
      .concat(_('Activation:'), '</strong> ')
      .concat(this.game.getTooltipActivation(card.activation), '\n        <br>\n        <br>\n        <strong>')
      .concat(_('Effect:'), '</strong> ')
      .concat(
        (_b =
          (_a = card.effect) === null || _a === void 0
            ? void 0
            : _a
                .map(function (text) {
                  return formatTextIcons(text);
                })
                .join('<br>')) !== null && _b !== void 0
          ? _b
          : '',
        '\n        '
      );
  ...
  BuilderCardsManager.prototype.getFullCardsByIds = function (ids) {
    ...
    return ids.map(function (id) {
      return _this.getFullCardById(id);
    });
  };
...
var TechnologyTilesManager = /** @class */ (function (_super) {
  ...
  TechnologyTilesManager.prototype.getTooltip = function (card) {
    ...
    var message = '\n        <strong>'
      .concat(card.name, '</strong>\n        <br>\n        <br>\n        <strong>')
      .concat(_('Type:'), '</strong> ')
      .concat(this.getType(card.type), '\n        <br>\n        <strong>')
      .concat(_('Level:'), '</strong> ')
      .concat(card.level + 1, '\n        <br>\n        <strong>')
      .concat(_('Activation:'), '</strong> ')
      .concat(this.game.getTooltipActivation(card.activation), '\n        ');
    if (card.requirement) {
      message += '\n            <br><br>\n            <strong>'.concat(_('Requirement:'), '</strong> ').concat(
        (_a = card.requirement
          .map(function (text) {
            return formatTextIcons(text);
          })
          .join('<br>')) !== null && _a !== void 0
          ? _a
          : '',
        '\n            '
      );
    }
    message += '\n        <br>\n        <br>\n        <strong>'.concat(_('Effect:'), '</strong> ').concat(
      (_c =
        (_b = card.effect) === null || _b === void 0
          ? void 0
          : _b
              .map(function (text) {
                return formatTextIcons(text);
              })
              .join('<br>')) !== null && _c !== void 0
        ? _c
        : '',
      '\n        '
    );
...
var TableCenter = /** @class */ (function () {
  function TableCenter(game, gamedatas) {
    ...
    [1, 2, 3].forEach(function (number) {
      ...
      _this.technologyTilesStocks[number].onCardClick = function (tile) {
        return _this.game.onTableTechnologyTileClick(tile);
      };
    });
  ...
  TableCenter.prototype.refreshTechnologyTiles = function (techs) {
    var _this = this;
    [1, 2, 3].forEach(function (number) {
      var tiles = _this.game.technologyTilesManager.getFullCards(
        techs.filter(function (tile) {
...
var PlayerTable = /** @class */ (function () {
  function PlayerTable(game, player) {
    ...
    ['ancient', 'writing', 'secret'].forEach(function (type) {
      html += '\n                    <div id="player-table-'
        .concat(_this.playerId, '-technology-tiles-deck-')
        .concat(type, '" class="technology-tiles-deck" data-type="')
        .concat(type, '"></div>\n                    ');
    });
    html += '\n            </div>\n            </div>\n        </div>\n        ';
    ...
    if (this.currentPlayer) {
      this.hand = new LineStock(
        ...
        {
          sort: function (a, b) {
            return a.id[0] == b.id[0] ? a.number - b.number : a.id.charCodeAt(0) - b.id.charCodeAt(0);
          },
        }
      );
    ...
    player.timeline.forEach(function (card) {
      return _this.createTimelineCard(_this.game.builderCardsManager.getFullCard(card));
    });
    timelineSlotsIds
      .map(function (slotId) {
        return timelineDiv.querySelector('[data-slot-id="'.concat(slotId, '"]'));
      })
    ...
    [0, 1, 2, 3, 4].forEach(function (space) {
      return artifactsSlotsIds.push('artefact-'.concat(space));
    }); // TODO artifact ?
    ...
    ['ancient', 'writing', 'secret'].forEach(function (type) {
      var technologyTilesDeckDiv = document.getElementById(
        'player-table-'.concat(_this.playerId, '-technology-tiles-deck-').concat(type)
      );
      _this.technologyTilesDecks[type] = new AllVisibleDeck(_this.game.technologyTilesManager, technologyTilesDeckDiv, {});
      var tiles = _this.game.technologyTilesManager.getFullCards(player.techs).filter(function (tile) {
  ...
  PlayerTable.prototype.setHandSelectable = function (selectionMode, selectableCards, stockState, reinitSelection) {
    ...
    if (stockState === void 0) {
      stockState = '';
    }
    if (reinitSelection === void 0) {
  ...
  PlayerTable.prototype.setTimelineSelectable = function (selectable, possibleCardLocations) {
    if (possibleCardLocations === void 0) {
      possibleCardLocations = null;
    }
    var slotIds = selectable ? Object.keys(possibleCardLocations) : [];
    document
      .getElementById('player-table-'.concat(this.playerId, '-timeline'))
  ...
  PlayerTable.prototype.setTimelineTokensSelectable = function (selectionMode) {
    document
      .getElementById('player-table-'.concat(this.playerId, '-timeline'))
      .querySelectorAll('.knowledge-token')
  ...
  PlayerTable.prototype.declineSlideLeft = function () {
    var shiftedCards = this.timeline.getCards().map(function (card) {
      return __assign(__assign({}, card), {
        location: card.location.replace(/(\d)/, function (a) {
          return ''.concat(Number(a) - 1);
        }),
      });
    });
...
var FrontEngine = /** @class */ (function () {
  ...
  FrontEngine.prototype.leaveState = function () {
    var _this = this;
    var _a;
    (_a = this.states.find(function (state) {
      return state.name == _this.currentState;
    })) === null || _a === void 0
      ? void 0
      : _a.onLeaving(this);
  };
...
var CreateEngineData = /** @class */ (function () {
  function CreateEngineData(selectedCard, selectedSlot, discardCards) {
    if (selectedCard === void 0) {
      selectedCard = null;
    }
    if (selectedSlot === void 0) {
      selectedSlot = null;
    }
    if (discardCards === void 0) {
      discardCards = [];
    }
...
var CreateEngine = /** @class */ (function (_super) {
    ...
    var _this =
      _super.call(this, game, [
        new FrontState(
          ...
          function (engine) {
            ...
            if (engine.data.selectedCard) {
              (_a = _this.game.builderCardsManager.getCardElement(engine.data.selectedCard)) === null || _a === void 0
                ? void 0
                : _a.classList.remove('created-card');
            ...
            var selectableCards = Object.keys(_this.possibleCardsLocations).map(function (id) {
              return _this.game.builderCardsManager.getFullCardById(id);
            });
        ...
        new FrontState(
          ...
          function (engine) {
            ...
            if (card.id[0] == 'A' || card.locked) {
              ...
              var stock =
                card.id[0] == 'A' ? _this.game.getCurrentPlayerTable().artifacts : _this.game.getCurrentPlayerTable().timeline;
        ...
        new FrontState(
          'confirm',
          function (engine) {
            engine.data.discardCards.forEach(function (card) {
              var _a;
              return (_a = _this.game.builderCardsManager.getCardElement(card)) === null || _a === void 0
                ? void 0
                : _a.classList.add('discarded-card');
            });
            ...
            if (artifact) {
              ...
              label = discardedCardsCount
                ? _('Confirm creation of Monument ${card_name} with ${number} discarded cards').replace(
                    '${number}',
                    discardedCardsCount
                  )
            ...
            _this.game.addPrimaryActionButton('confirmCreate_btn', label, function () {
              return _this.game.onCreateCardConfirm(engine.data);
            });
            _this.addCancel();
          },
          function (engine) {
            ...
            engine.data.discardCards.forEach(function (card) {
              ...
              return (_a = _this.game.builderCardsManager.getCardElement(card)) === null || _a === void 0
                ? void 0
                : _a.classList.remove('discarded-card');
            });
            _this.removeCancel();
  ...
  CreateEngine.prototype.selectCard = function (card) {
    ...
    (_a = this.game.builderCardsManager.getCardElement(card)) === null || _a === void 0
      ? void 0
      : _a.classList.add('created-card');
  ...
  CreateEngine.prototype.addCancel = function () {
    var _this = this;
    this.game.addSecondaryActionButton('restartCardCreation_btn', _('Restart card creation'), function () {
      return _this.nextState('init');
    });
  };
  ...
  CreateEngine.prototype.addConfirmDiscardSelection = function () {
    var _this = this;
    this.game.addPrimaryActionButton('confirmDiscardSelection_btn', _('Confirm discarded cards'), function () {
      return _this.nextState('confirm');
    });
    this.setConfirmDiscardSelectionState();
  };
  ...
  CreateEngine.prototype.setConfirmDiscardSelectionState = function () {
    ...
    (_a = document.getElementById('confirmDiscardSelection_btn')) === null || _a === void 0
      ? void 0
      : _a.classList.toggle('disabled', discardCount != this.data.discardCards.length);
  };
  CreateEngine.prototype.getDiscardCount = function () {
    ...
    var slot = card.id[0] == 'A' || card.locked ? Object.keys(this.possibleCardsLocations[card.id])[0] : this.data.selectedSlot;
...
var ArchiveEngine = /** @class */ (function (_super) {
      ...
      _super.call(this, game, [
          ...
          function (engine) {
            ...
            var cards = _this.game
              ...
              .filter(function (card) {
                return possibleCards.includes(card.id);
              });
        ...
        new FrontState(
          ...
          function (engine) {
            ...
            _this.game.changePageTitle('Confirm', true);
            var label = formatTextIcons(_('Confirm discard of ${number} cards to remove ${number} <KNOWLEDGE>')).replace(
              /\${number}/g,
              '' + discardCount
            );
            _this.game.addPrimaryActionButton('confirmArchive_btn', label, function () {
              return _this.game.onArchiveCardConfirm(engine.data);
            });
            _this.addCancel();
          },
          function (engine) {
  ...
  ArchiveEngine.prototype.addConfirmDiscardSelection = function () {
    ...
    this.game.addPrimaryActionButton('confirmDiscardSelection_btn', _('Confirm discarded cards'), function () {
      return _this.game.onArchiveCardConfirm(_this.data);
    });
    this.setConfirmDiscardSelectionState();
  };
  ...
  ArchiveEngine.prototype.addConfirmDiscardTokenSelection = function () {
    var _this = this;
    this.game.addPrimaryActionButton('confirmDiscardTokenSelection_btn', _('Confirm discarded tokens'), function () {
      return _this.nextState('confirm');
    });
    this.setConfirmDiscardTokenSelectionState();
  };
  ...
  ArchiveEngine.prototype.setConfirmDiscardSelectionState = function () {
    ...
    (_a = document.getElementById('confirmDiscardSelection_btn')) === null || _a === void 0
      ? void 0
      : _a.classList.toggle('disabled', discardCount == 0);
  };
...
var Heat = /** @class */ (function () {
    ...
    if (/* TODO? this._activeStates.includes(stateName) ||*/ this.isCurrentPlayerActive()) {
      if (args.args && args.args.optionalAction && !args.args.automaticAction) {
        this.addSecondaryActionButton(
          ...
          _('Pass'),
          function () {
            return _this.takeAction('actPassOptionalAction');
          },
          'restartAction'
        );
      }
      // Undo last steps
      (_b = (_a = args.args) === null || _a === void 0 ? void 0 : _a.previousSteps) === null || _b === void 0
        ? void 0
        : _b.forEach(function (stepId) {
            var logEntry = $('logs').querySelector('.log.notif_newUndoableStep[data-step="'.concat(stepId, '"]'));
            if (logEntry) {
              _this.onClick(logEntry, function () {
                return _this.undoToStep(stepId);
              });
            }
        ...
        if ((_d = args.args) === null || _d === void 0 ? void 0 : _d.previousSteps) {
          ...
          if (lastStep_1 > 0)
            this.addDangerActionButton(
              ...
              _('Undo last step'),
              function () {
                return _this.undoToStep(lastStep_1);
              },
              'restartAction'
            );
        }
    ...
    if (this.isCurrentPlayerActive()) {
      switch (stateName) {
        ...
        case 'chooseAction':
          ...
          break;
        case 'confirmTurn':
          this.addActionButton('actConfirmTurn_button', _('Confirm turn'), function () {
            return _this.actConfirmTurn();
          });
        //(this as any).addActionButton(`actRestart_button`, _("Restart"), () => this.actRestart(), null, null, 'gray');
      }
    } else {
  ...
  Heat.prototype.createPlayerPanels = function (gamedatas) {
    ...
    Object.values(gamedatas.players).forEach(function (player) {
      ...
      var html = '<div class="counters">\n                <div id="playerhand-counter-wrapper-'
        ...
        .concat(
          player.id,
          '"></span>\n                </div>\n            \n                <div id="lost-knowledge-counter-wrapper-'
        )
        .concat(
          player.id,
          '" class="lost-knowledge-counter">\n                    <div class="lost-knowledge icon"></div>\n                    <span id="lost-knowledge-counter-'
        )
        .concat(
          player.id,
  ...
  Heat.prototype.onTableTechnologyTileClick = function (tile) {
    if (this.gamedatas.gamestate.name == 'learn') {
      this.takeAtomicAction('actLearn', [tile.id]);
    }
  };
  ...
  Heat.prototype.onCreateCardConfirm = function (data) {
    this.takeAtomicAction('actCreate', [
  ...
  Heat.prototype.onArchiveCardConfirm = function (data) {
  ...
  Heat.prototype.takeAtomicAction = function (action, args, warning) {
    if (args === void 0) {
      args = {};
    }
    if (warning === void 0) {
  ...
  Heat.prototype.notif_createCard = function (args) {
    if (args.card.id[0] == 'T') {
  ...
  Heat.prototype.notif_fillPool = function (args) {
    var _this = this;
  ...
  Heat.prototype.notif_discardLostKnowledge = function (args) {
    //  TODO
  };
  Heat.prototype.notif_learnTech = function (args) {
  ...
  Heat.prototype.notif_declineCard = function (args) {
    return this.getPlayerTable(args.player_id).declineCard(args.card);
  };
  Heat.prototype.notif_declineSlideLeft = function (args) {
...
et pour actRemoveKnowleldge j'attends un tableau associatif : ['cardId' => n1, 'cardId2' => n2, ...]
  ...
  Heat.prototype.onAddingNewUndoableStepToLog = function (notif) {
    ...
    if (
      (_d =
        (_c =
          (_b = (_a = this.gamedatas) === null || _a === void 0 ? void 0 : _a.gamestate) === null || _b === void 0
            ? void 0
            : _b.args) === null || _c === void 0
          ? void 0
          : _c.previousSteps) === null || _d === void 0
        ? void 0
        : _d.includes(parseInt(stepId))
    ) {
      this.onClick($('log_'.concat(notif.logId)), function () {
        return _this.undoToStep(stepId);
      });
      if ($('dockedlog_'.concat(notif.mobileLogId))) {
  ...
  Heat.prototype.getGain = function (type) {
    switch (type) {
      case 1:
  ...
  Heat.prototype.getTooltipActivation = function (activation) {
    switch (activation) {
      case 'anytime':
        return _('Ongoing (with conditions)');
      case 'decline':
        return _('Decline Phase');
      case 'immediate':
        return _('Immediate');
      case 'timeline':
        return _('Timeline Phase');
      case 'endgame':
        return _('Final Scoring');
    }
  };
