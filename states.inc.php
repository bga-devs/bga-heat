...
$machinestates = [
  ...
  ST_PLANIFICATION => [
    ...
    'descriptionenhanced' => clienttranslate('Waiting for other players to take their turn'),
    'descriptionmyturnenhanced' => clienttranslate('${you} must select the gear and card(s) to play'),
    'type' => 'multipleactiveplayer',
